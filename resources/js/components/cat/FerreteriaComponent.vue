<template>
    <div>
        <a href="#" class="block w-full h-full relative">
            <img class="banner-image-cat" src="https://mercadomi.com.ec/storage/31/conversions/ferreteria.png" alt="banner" loading="lazy">
...
export default {
    ...
    data() {
        return {
            ...
            staticCategories: [
    { title: 'SECCIÓN', name: 'HERRAMIENTAS MANUALES', link: '/#/product?category=herramientas-manuales', buttonText: 'VEITANOS' },
